    ...
    <div class="container text-center">
      <div class="row justify-content-center">
        <div class="col-md-7">
          ...
          <br>
          <p class="lead text-white-50">여러 사이트를 통해 수집한 리뷰를 바탕으로 분석한 정확한 정보를 얻을 수 있습니다.</p>
	...
	<ul class="tagul" style="overflow: hidden;">
		<li class="tag_li">
			<a href="/search.php?mode=0&amp;q=%EC%BB%A4%ED%94%BC+%EC%B9%B4%ED%8E%98%EC%8A%A4%ED%83%80%EA%B7%B8%EB%9E%A8+%EC%B9%B4%ED%8E%98+">
				<div class="img_box">
					<img src="https://startag.io/img/img_tag_cafe.jpg" class="tag_img">
				</div>
				<p class="tag_p">LG 그램</p> <!--추천 계정 : @ ID / #,@와 태그,계정아이디 사이에 띄워쓰기 하나 꼭 해주세요-->
			</a>
		</li>
		<li class="tag_li"><a
			href="/search.php?mode=0&amp;q=%EC%9D%BC%EC%83%81%EC%BD%94%EB%94%94+%EC%BD%94%EB%94%94%EC%B6%94%EC%B2%9C+%EB%8D%B0%EC%9D%BC%EB%A6%AC%EC%BD%94%EB%94%94+">
				<div class="img_box">
					<img src="https://startag.io/img/img_tag_fashion.jpg"
						class="tag_img">
				</div>
				<p class="tag_p">맥북</p> <!--추천 계정 : @ ID / #,@와 태그,계정아이디 사이에 띄워쓰기 하나 꼭 해주세요-->
		</a></li>
		<li class="tag_li"><a
			href="/search.php?mode=0&amp;q=%EC%9D%8C%EC%8B%9D%EC%8A%A4%ED%83%80%EA%B7%B8%EB%9E%A8+%EB%A7%9B%EC%A7%91%EA%B7%B8%EB%9E%A8+%EA%B2%BD%EB%A6%AC%EB%8B%A8%EA%B8%B8%EB%A7%9B%EC%A7%91">
				<div class="img_box">
					<img src="https://startag.io/img/img_tag_eat.jpg" class="tag_img">
				</div>
				<p class="tag_p">삼성 울트라PC</p> <!--추천 계정 : @ ID / #,@와 태그,계정아이디 사이에 띄워쓰기 하나 꼭 해주세요-->
		</a></li>
		<li class="tag_li"><a
			href="/search.php?mode=0&amp;q=%ED%99%94%EC%9E%A5%ED%92%88%EC%B6%94%EC%B2%9C+%EB%B7%B0%ED%8B%B0%EA%B7%B8%EB%9E%A8+kbeauty">
				<div class="img_box">
					<img src="https://startag.io/img/img_tag_beauty.jpg"
						class="tag_img">
				</div>
